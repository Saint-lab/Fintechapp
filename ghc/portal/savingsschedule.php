            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="white-box">
                            <h5 class="box-title">Periodic Savings Schedule</h5>
                               <div class="row">
                                <form method="post">
                                    ...
                                    <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                $status = ($profile->trackPaid($userKey,$trackdate)==0)?'Pending':'Paid'; 
                                                if($profile->attStatus($userKey,$trackdate)==0){ ?>
                                                    <tr class="unread">
                                                        <td>
                                                            <div class="checkbox m-t-0 m-b-0">
                                            ...
                                            <button class="btn btn-success btn-lg pull-right" name="PayMultiple" value="<?php echo $userKey; ?>">PAY FOR SELECTED DAYS</button>
                                </form>
                                   </div>
                                </div>
                            </div>
