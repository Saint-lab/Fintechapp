...
<?php if(isset($report)){echo $signup->Alert(); } ?>
 ...
 <div class="col-md-12 col-sm-12">
                        <div class="white-box stat-widget">
                            ...
                            <h5>Loan Applications</h5>
                               <?php echo $profile->loanApplications(1); ?>
 ...
 <div class="col-md-12 col-sm-12">
                        <div class="white-box stat-widget">
                            ...
                            <h5>Approved Loans Awaiting Acceptance</h5>
                               <?php echo $profile->loanApplications(2); ?>
 ...
 <div class="col-md-12 col-sm-12">
                        <div class="white-box stat-widget">
                            ...
                            <h5>Disbursed Loans</h5>
                               <?php echo $profile->loanApplications(4); ?>
